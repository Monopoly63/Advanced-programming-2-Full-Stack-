// =============================================================================
//  Anecdotes App — pick a random quote, vote, and show the most voted one.
//  Concepts: useState, useEffect, immutable array updates via spread operator.
// =============================================================================
...
const App = () => {
  ...
  // Trigger a scale animation whenever the selected quote or votes change.
  useEffect(() => {
    setAnimate(true);
  ...
  // Create an immutable copy of the votes array before updating it.
  const handleVote = () => {
  ...
  return (
    <div style={{ textAlign: 'center', marginTop: '50px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div>
        <button style={{ ...buttonStyle, backgroundColor: '#4CAF50' }} onClick={handleVote}>
          Vote
        </button>
        <button style={{ ...buttonStyle, backgroundColor: '#2196F3' }} onClick={handleNextAnecdote}>
          Next Quote
        </button>
      </div>
